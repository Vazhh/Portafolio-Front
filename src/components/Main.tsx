...
export default function Main() {
    const linkedin = () => {
        setTimeout(() => window.location.href = 'https://www.linkedin.com/in/robinson-gerardo-aguirre-duque-desarrollador-web-full-stack/', 500)
    }

    const gitHub = () => {
        setTimeout(() => window.location.href = 'https://github.com/Vazhh', 500)
    }

    return (
        <div className="w-[50vw] grid grid-rows-3 h-full">
            <div className="relative flex justify-center xl:top-16 2xl:top-20 w-full mt-5">
            ...
            <div className=" xl:mt-32 2xl:mt-40 ">
            ...
            <div className="xl:mt-32 2xl:mt-40 ps-10 h-20  flex justify-between pr-6">
                <button className="border-2 xl:h-10 2xl:h-10 border-[#E35D5D] rounded-ss-xl rounded-br-xl hover:scale-110 hover:bg-gradient-to-br from-pink-500 to-orange-400 font-bold py-2 px-4 rounded inline-flex items-center">
                    ...
                    <svg className="dark:fill-white xl:w-4 xl:h-4 2xl:w-4 2xl:h-4 ms-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z" /></svg>
                </button>
                <div className="flex inset-0 h-16">
                    <svg onClick={linkedin} className="xl:w-8 xl:h-8 2xl:w-9 2xl:h-9 mr-5 hover:scale-110 hover:cursor-pointer" width="256" height="256" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 256"><path d="M218.123 218.127h-37.931v-59.403c0-14.165-.253-32.4-19.728-32.4-19.756 0-22.779 15.434-22.779 31.369v60.43h-37.93V95.967h36.413v16.694h.51a39.907 39.907 0 0 1 35.928-19.733c38.445 0 45.533 25.288 45.533 58.186l-.016 67.013ZM56.955 79.27c-12.157.002-22.014-9.852-22.016-22.009-.002-12.157 9.851-22.014 22.008-22.016 12.157-.003 22.014 9.851 22.016 22.008A22.013 22.013 0 0 1 56.955 79.27m18.966 138.858H37.95V95.967h37.97v122.16ZM237.033.018H18.89C8.58-.098.125 8.161-.001 18.471v219.053c.122 10.315 8.576 18.582 18.89 18.474h218.144c10.336.128 18.823-8.139 18.966-18.474V18.454c-.147-10.33-8.635-18.588-18.966-18.453" fill="#0A66C2" /></svg>
                    <svg
                        onClick={gitHub}
                        className="xl:w-8 xl:h-8 2xl:w-9 2xl:h-9 hover:scale-110 hover:cursor-pointer dark:fill-white"
                        viewBox="0 0 256 250"
                        width="256"
                        height="250"
                        fill="currentColor"
