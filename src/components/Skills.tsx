export default function Skills() {
    return (
        <div className="w-[50vw] flex justify-center z-0 h-full pt-28">
            <div className="card">
            <div className="item">
            <svg className="html" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 452 520">
                ...
                <span className="itemText">HTML</span>
            </div>
            <div className="item">
                <svg className="css" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 452 520">
                ...
                <span className="itemText">CSS</span>
            </div>
            <div className="item">
                <svg className="javas" xmlns="http://www.w3.org/2000/svg" width="2500" height="2500"
                ...
                <span className="itemText">JAVASCRIPT</span>
            </div>
            <div className="item">
                <svg className="react" viewBox="0 0 256 228" width="256" height="228" xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="itemText">REACT</span>
            </div>
            <div className="item">
                <svg className="node" viewBox="0 0 256 292" xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="itemText">NODE</span>
            </div>
            <div className="item">
                <svg className="express" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="64" height="64">
                    <path
                ...
                <span className="itemText">EXPRESS</span>
            </div>
            <div className="item">
                <svg className="mongo" viewBox="0 0 256 549" xmlns="http://www.w3.org/2000/svg" width="256" height="549"
                    preserveAspectRatio="xMidYMid">
                    <path fill="#01EC64"
                ...
                <span className="itemText">MONGO DB</span>
            </div>
            <div className="item">
                <svg className="tail" viewBox="0 0 256 154" width="256" height="154" xmlns="http://www.w3.org/2000/svg"
                    preserveAspectRatio="xMidYMid">
                    <defs>
                ...
                <span className="itemText">TAILWIND</span>
            </div>
            <div className="item">
                <svg className="boots" viewBox="0 0 256 204" xmlns="http://www.w3.org/2000/svg" width="256" height="204"
                    preserveAspectRatio="xMidYMid">
                    <path fill="#7E13F8"
                ...
                <span className="itemText">BOOTSTRAP</span>
            </div>
            <p className="text">HOVER FOR SKILLS</p>
